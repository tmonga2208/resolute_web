...
export default function SplitCarousel() {
  ...
  return (
    <div className="font-mont relative w-full mx-auto overflow-hidden">
      <div
      ...
      >
        ...
        <div className="flex flex-col md:flex-row w-full flex-shrink-0">
          <div className="w-full md:w-1/2 rounded-none bg-[#c6e8e9]">
            <CardContent className=" flex flex-col items-center justify-center text-xl font-semibold mb-8">
              <Image src="/logo2.png" width={350} height={350} alt="resolute" />
              <Button className="bg-teal-700 text-sm px-8 rounded-2xl" onClick={nextSlide}>GET STARTED</Button>
            </CardContent>
          </div>
          <div className="w-full md:w-1/2  rounded-none bg-[#c6e8e9] bg-[url(/bg4.jpg)] bg-cover">
            <CardContent className="flex h-full items-center justify-center text-4xl font-medium text-white">
              <div className="flex flex-col items-center justify-center gap-3 font-mollie">
              <p>Reset.</p>
              <p>Refocus.</p>
              <p>Regain.</p>
              </div>
        ...
        <div className="flex flex-col md:flex-row w-full flex-shrink-0">
          <div className="w-full md:w-1/2 rounded-none bg-[#c6e8e9]">
            ...
            <CardContent className="flex items-center justify-center text-xl font-semibold">
              <div className="flex items-center justify-center h-full">
                <div className="grid grid-rows-1 sm:grid-cols-2 gap-4">
                  <div>
                    <Label className="block text-sm font-medium text-gray-700">First Name</Label>
                    <Input className="bg-white" type="text" value={fname} onChange={(e)=>{setFname(e.target.value)}} />
                  </div>
                  <div>
          ...
          <div className="w-full md:w-1/2 rounded-none bg-[#c6e8e9]">
            <CardContent className="flex flex-col text-xl font-semibold">
        ...
        <div className="flex w-full flex-col md:flex-row  flex-shrink-0">
          <CardTitle className="absolute top-4 w-full text-3xl flex justify-center items-center">Thank you for reaching out to us, {fname}</CardTitle>
          <div className="w-full md:w-1/2  rounded-none bg-[#c6e8e9]">
            <CardContent className="mt-24 flex flex-col text-xl font-semibold">
          ...
          <div className="w-full md:w-1/2 rounded-none bg-[#c6e8e9]">
            <CardContent className="flex flex-col text-xl font-semibold">
              <div className="mt-24 items-center justify-center">
              <Label className="block text-sm font-medium text-gray-700">Brief Describe What You Need Help With?</Label>
              <Textarea className="bg-white h-24" />
              </div>
              <div className="flex items-baseline justify-baseline">
                <Button className="mt-8 bg-teal-700 text-sm px-8 rounded-2xl" onClick={nextSlide}>GET STARTED</Button>
